...
ALTER TABLE seatings_assignments 
    ADD CONSTRAINT fk_student_seating_assignment FOREIGN KEY (student_id) REFERENCES students(id),
    ADD CONSTRAINT fk_seat_seating_assignment FOREIGN KEY (seat_id) REFERENCES seats(id);
...
ALTER TABLE absents 
    ALTER COLUMN student_id SET NOT NULL,
    ALTER COLUMN absent_date SET NOT NULL,
...
ALTER TABLE desks 
    ...
    ALTER COLUMN col_index SET NOT NULL,
    ALTER COLUMN seats_count SET NOT NULL;
...
ALTER TABLE cabinets 
    ADD CONSTRAINT chk_cabinet_rows CHECK (rows_count > 0),
    ADD CONSTRAINT chk_cabinet_cols CHECK (cols_count > 0);

ALTER TABLE desks 
    ADD CONSTRAINT chk_desk_row_index CHECK (row_index >= 0),
    ADD CONSTRAINT chk_desk_col_index CHECK (col_index >= 0),
    ADD CONSTRAINT chk_desk_seats_quantity CHECK (seats_count > 0);
